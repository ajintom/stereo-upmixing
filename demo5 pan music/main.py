...
v = 0.00000001		 #low floor
E = 0.125		 #gaussian window width
si_l = 0.0	 #panning index for left
si_c = 1.0		 #panning index for center
si_r = -1.0		 #panning index for right
#--------------------------------------------------------------------------------
#reading from wavfile
#fs, signal_read = wf.read('trio_dry.wav') # bass, violin, guitar trio
fs, signal_read = wf.read('voc_pl_sr_hard.wav') # read stereo from wavfile
...
#synthL_F = synthL_F - synth_aL #subtracting ambienceLEFT from originalLEFT
#synthR_F = synthR_F - synth_aR #subtracting ambienceLEFT from originalLEFT
